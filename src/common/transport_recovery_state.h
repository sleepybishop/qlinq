 ...
 * Retain a bounded 4096-object history, matching the sender cache slot
 * bound for every configured object size and byte budget. */
#define QLINQ_RECOVERY_MAX_WINDOWS TRANSPORT_RECOVERY_MAX_WINDOWS
