...
#define TRANSPORT_RECOVERY_MAX_WINDOWS 128U
#define TRANSPORT_RECOVERY_MAX_OBJECTS                                         \
  (TRANSPORT_RECOVERY_WINDOW_OBJECTS * TRANSPORT_RECOVERY_MAX_WINDOWS)
...
#define TRANSPORT_MAX_FEC_GROUP_SIZE (32U * 1024U)
